...
START_TEXT = """
<b>🔥Привет, это бот в котором ты можешь увидеть расписание своей группы в АПТ.</b>

📌Сначала нужно указать свою группу, нажав кнопку <b>"Изменить группу📎"</b> и ввести группу <b>без лишних букв и дефисов</b>, например было <b>ис-211 Б</b> , нужно написать просто <b>ис211</b>.

📌<b>Расписание на сегодня/завтра🗓</b> ➖ выводит расписание в виде текста.

📌<b>Расписание на сегодня/завтра📱</b> ➖ выводит расписание в виде картинки.
...
📌Сначала нужно указать свою группу, нажав кнопку <b>"Изменить группу📎"</b> и ввести группу <b>без лишних букв и дефисов</b>, например было ис-211 Б , нужно написать просто ис211.

📌<b>Расписание на сегодня/завтра🗓</b> ➖ выводит расписание в виде текста.

📌<b>Расписание на сегодня/завтра📱</b> ➖ выводит расписание в виде картинки.

📌Кнопка <b>"Расписание на понедельник📅"</b> ➖ работает только в субботу и воскресенье и выводит расписание картинкой.

📌Нажав  <b>"Изменить группу📎"</b> еще раз, ты можешь поменять свою группу.

📌Нажав кнопку <b>"Профиль📌"</b> ты можешь увидеть свой id и группу.

📌Если что то забыл или запутался ➖ жми <b>"Помощь❓"</b>

🆘<b>ВАЖНО</b>🆘Если кнопка не работает нажмите еще раз (при первом запуске тоже)!

❗️Может понадобиться несколько секунд для получения расписания!"""
